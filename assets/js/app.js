(function (root) {
  ...
  function addShiftByDialog() {
    ...
    TS.tutors.openShiftDialog(state,
      { tutorId: selectedTutorId || state.tutors[0].id, day: 0 },
      function (value) {
   ...
   * calendar, but which tutor works it cannot.
   */
  ...
  var SETTING_FIELDS = [
    ...
    { key: 'location', label: 'Tutoring room', type: 'text',
      hint: 'Where tutoring is held. A faculty member with office hours elsewhere has ' +
        'their own room, set under Edit on their row.' },
